...
import 'package:ocp/widgets/animated_fade.dart';
import 'package:ocp/widgets/animated_rotation.dart';
import 'package:ocp/widgets/animated_slide.dart';
import 'package:ocp/widgets/machine_type.dart';
...
class MachineOverallInfo extends StatefulWidget {
  @override
  _MachineOverallInfoState createState() => _MachineOverallInfoState();
}

class _MachineOverallInfoState extends State<MachineOverallInfo> with TickerProviderStateMixin {
    ...
    return Padding(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          // the Machine name when the card scroll up
          Opacity(
            opacity: 0.0,
            child: Text(
              "Cherry",
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                Hero(
                  tag: "BulbasaurGrass",
                  child: MachineType("Grass", large: true),
                ),
                SizedBox(width: 7),
                Hero(
                  tag: "BulbasaurPoison",
                  child: MachineType("Poison", large: true),
                ),
              ],
            ),
            AnimatedSlide(
  ...
  Widget _buildMachineSlider(BuildContext context) {
    final cardScrollController = Provider.of<AnimationController>(context);
          ...
          children: <Widget>[
            ...
            PageView.builder(
              ...
              itemBuilder: (context, index) => Hero(
                tag: index == 0 ? "assets/images/cherry.png" : "",
  ...
  Widget build(BuildContext context) {
    ...
    final machineSize = screenWidth * 0.448;

    final machineTop = -(machineSize / 2 - (IconTheme.of(context).size / 2 + _appBarTopPadding));
    final machineRight = -(machineSize / 2 - (IconTheme.of(context).size / 2 + _appBarHorizontalPadding));
