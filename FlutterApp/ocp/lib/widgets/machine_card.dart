...
String _formattedMachineIndex(int index) {
...
class MachineCard extends StatelessWidget {
  ...
  List<Widget> _buildTypes() {
    final widgetTypes = machine.types
        .map(
          (type) => Hero(
            tag: machine.name + type,
            child: MachineType(capitalizeFirstChar(type)),
          ),
        )
  ...
  List<Widget> _buildDecorations(double itemHeight) {
    return [
      ...
      Positioned(
        ...
        right: 14,
        child: Text(
          _formattedMachineIndex(this.index),
          style: TextStyle(
            fontSize: 14,
            fontWeight: FontWeight.bold,
      ...
      builder: (context, constrains) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color:  machine.color.withOpacity(0.30),
                blurRadius: 15,
                offset: Offset(0, 8),
              ),
            ],
